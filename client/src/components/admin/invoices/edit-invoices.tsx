...
export const EditInvoices = () => {
  ...
  React.useEffect(() => {
    async function fetchData(id: string) {
      // You can await here
      await axios({
        url: `${environment.api}invoices/${id}`,
        method: "GET",
            ...
            >
              ...
              <div className="col-span-1 flex items-center">
                <FormControl fullWidth>
                  <InputLabel id="Select-Invoices-Type-label">
                    Select Invoices Type
                  </InputLabel>
                  <Select
                    labelId="Select-Invoices-Type-label"
                    id="Select-Invoices-Type"
                    label="Select Invoices Type"
